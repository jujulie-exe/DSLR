...
mean,39.79713089016475,1.1410195296768044,3.153909673286355,-224.58991486346417,495.74797005915786,2.963094615116594,1030.0969463871304,5.95037299278009,-243.3744090125,21.9580125
sigma,514.904736429893,5.163925073157659,4.103030881423507,480.8423325139229,105.08265387187238,4.364496027131785,43.63982882393576,3.117210254470139,8.780894559533115,97.60108742375692
...
def main(path_to_test_file: str, path_to_weight_file: str) -> int:
    try:
        ...
        data_cleaning_test, houses_test, materie_test = lrt.cleaning(data_test, lrt.OPTIONAL_DROP_COLUMNS)
